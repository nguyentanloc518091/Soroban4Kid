...
; (function ($, window, document, undefined) {
    ...
    FlipCounter.prototype.updateTo = function (num) {
        ...
        for (i = 0; i < numStr.length; i = i + 1) {
            this.digits[i].flipTo(numStr[numStr.length - 1 - i], numStr.length);
    ...
    Digit.prototype.flipTo = function (num, len) {
        this.counter = len;
        console.log(this.currentNum, num)
        ...
        digit.bottomFrontDiv.tween({
            transform: {
                ...
                onStop: function () {
                    ...
                    digit.stop++;
                    if (digit.stop == digit.counter) {
                        // alert(digit.counter + ' complete ' + digit.stop);
